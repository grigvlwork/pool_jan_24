...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.task_tb = QtWidgets.QTextBrowser(self.tab_3)
        self.task_tb.setObjectName("task_tb")
        self.horizontalLayout_8.addWidget(self.task_tb)
        self.correct_tw.addTab(self.tab_3, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.correct_tw.setTabText(self.correct_tw.indexOf(self.tab_3), _translate("MainWindow", "Задача"))
        self.correct_tw.setTabToolTip(self.correct_tw.indexOf(self.tab_3), _translate("MainWindow", "Задача"))
